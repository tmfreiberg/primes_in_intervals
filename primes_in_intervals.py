...
def display(dataset, orient='index', description='on', zeroth_item='show', count='cumulative', comparisons='off', single_cell='true'): 
    ...
    # single_cell either 'false' or not (detaults to 'true').
    if 'data' in dataset.keys():
